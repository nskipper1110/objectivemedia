...
#ifndef _Included_com_mti_primitives_codecs_H263VideoDecoder
#define _Included_com_mti_primitives_codecs_H263VideoDecoder
...
/**
 * Opens an H.263p decoder for use in future decoder.
 * Parameters:
 ...
 */
EMSCRIPTEN_KEEPALIVE int js_H263VideoDecoder_PlatformOpen(int videoType, int width, int height, int fps, int pixelFormat, int bitRate, int isVBS, int quality, int crispness, int kfs);

/**
 * Closes the decoder.
 */
EMSCRIPTEN_KEEPALIVE int js_H263VideoDecoder_PlatformClose();

/**
 * Not implemented, returns null.
 */
EMSCRIPTEN_KEEPALIVE unsigned char* js_H263VideoDecoder_PlatformEncode(char* sample, int size, long timestamp);
 ...
 */
EMSCRIPTEN_KEEPALIVE unsigned char* js_H263VideoDecoder_PlatformDecode(char* sample, int size, long timestamp);
