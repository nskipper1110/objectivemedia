...
/**
 * This class provides functionality for decoding g.723.1 audio packets.
 * @author Natghan Skipper, Montgomery Technology, Inc., nathan@montgomerytechnology.com
 * @version 1.0.0
 * @since 1/4/2013
 */
public class G7231AudioDecoder extends Codec{
    public G7231AudioDecoder(){
        super();
    }
    /**
