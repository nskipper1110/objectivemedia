...
/**
 * This class provides definition for the h.264 Decoder.
 * @author Nathan Skipper, Montgomery Technology, Inc., nathan@montgomerytechnology.com
 * @version 1.0.0
 * @since 1/4/2013
 */
public class H263VideoDecoder extends Codec{
    
    public H263VideoDecoder(){
        super();
    }
    /**
     ...
     * from a VC-1 packet.
     * @param inSample - The h.264 packet to decode.
