...
<<<<<<< HEAD
#define FFMPEG_CONFIGURATION "--prefix=./build/mac/x64 --enable-yasm --disable-shared --enable-static --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-everything --disable-muxers --disable-demuxers --disable-parsers --disable-filters --disable-hwaccels --enable-decoder=rawvideo --enable-encoder=rawvideo --enable-decoder=h263 --enable-encoder=h263p --enable-encoder=mjpeg --enable-decoder=mjpeg --enable-encoder=g723_1 --enable-decoder=g723_1 --enable-indev=avfoundation --target-os=darwin arch=x86_64 --enable-cross-compile --cc='gcc -fPIC'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2014
#define FFMPEG_DATADIR "./build/mac/x64/share/ffmpeg"
#define AVCONV_DATADIR "./build/mac/x64/share/ffmpeg"
