...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=./build/js/x86 --target-os=none arch=x86 --enable-cross-compile --cc=emcc --extra-cflags='-s ERROR_ON_UNDEFINED_SYMBOLS=0' --disable-runtime-cpudetect --disable-doc --disable-asm --enable-gpl --disable-fast-unaligned --disable-pthreads --disable-w32threads --disable-os2threads --disable-debug --disable-stripping --disable-everything --disable-asm --enable-shared --enable-static --disable-muxers --disable-demuxers --disable-parsers --disable-filters --disable-hwaccels --enable-decoder=rawvideo --enable-encoder=rawvideo --enable-decoder=h263 --enable-encoder=h263p --enable-encoder=mjpeg --enable-decoder=mjpeg --enable-decoder=h264 --enable-parser=h264 --disable-network --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-bzlib --disable-iconv --disable-xlib --disable-zlib
prefix=./build/js/x86
...
CC_IDENT=emcc (Emscripten gcc/clang-like replacement) 1.38.13 (commit 2951f717b00b433613dee1515748ef574b144db1)
ARCH=c
INTRINSICS=none
CC=emcc
CXX=g++
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -I$(SRC_PATH)/compat/atomics/gcc
CFLAGS=  -s ERROR_ON_UNDEFINED_SYMBOLS=0 -std=c11 -fomit-frame-pointer -s USE_SDL=2 -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=  -s ERROR_ON_UNDEFINED_SYMBOLS=0 -Qunused-arguments
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
