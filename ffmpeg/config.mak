...
FFMPEG_CONFIG_MAK=1
<<<<<<< HEAD
FFMPEG_CONFIGURATION=--prefix=./build/mac/x64 --enable-yasm --disable-shared --enable-static --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-everything --disable-muxers --disable-demuxers --disable-parsers --disable-filters --disable-hwaccels --enable-decoder=rawvideo --enable-encoder=rawvideo --enable-decoder=h263 --enable-encoder=h263p --enable-encoder=mjpeg --enable-decoder=mjpeg --enable-encoder=g723_1 --enable-decoder=g723_1 --enable-indev=avfoundation --target-os=darwin arch=x86_64 --enable-cross-compile --cc='gcc -fPIC'
prefix=./build/mac/x64
=======
FFMPEG_CONFIGURATION=--prefix=./build/win/x64 --disable-yasm --disable-shared --enable-static --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-everything --disable-muxers --disable-demuxers --disable-parsers --disable-filters --disable-hwaccels --enable-decoder=rawvideo --enable-encoder=rawvideo --enable-demuxer=asf --enable-muxer=asf --enable-decoder=h263 --enable-encoder=h263p --enable-encoder=mjpeg --enable-decoder=mjpeg --enable-encoder=g723_1 --enable-decoder=g723_1 --enable-indev=dshow --target-os=mingw32 --arch=x86_64 --enable-cross-compile --cc='gcc -m64 -fPIC'
prefix=./build/win/x64
...
CC=gcc -fPIC
CXX=g++
AS=gas-preprocessor.pl gcc -fPIC
LD=gcc -fPIC
DEPCC=gcc -fPIC
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl gcc -fPIC
=======
CC_IDENT=gcc 6.1.0 (x86_64-posix-seh, Built by MinGW-W64 project)
ARCH=x86
CC=gcc -m64 -fPIC
CXX=g++
AS=gcc -m64 -fPIC
...
CFLAGS=-I/opt/local/include/freetype2   -std=c99 -mdynamic-no-pic -fomit-frame-pointer -fPIC -pthread -D_GNU_SOURCE=1 -D_THREAD_SAFE -I/usr/local/include/SDL -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -DPIC
CFLAGS=   -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=   -fPIC -g
>>>>>>> 5fcdb63f808c240c88075109189721697b65ab66
AS_C=-c
...
<<<<<<< HEAD
DEPWINDRES=gcc -fPIC
LDFLAGS=-L/opt/local/lib -lfreetype  -Wl,-dynamic,-search_paths_first -Qunused-arguments
SHFLAGS=-dynamiclib -Wl,-single_module -Wl,-install_name,$(SHLIBDIR)/$(SLIBNAME_WITH_MAJOR),-current_version,$(LIBVERSION),-compatibility_version,$(LIBMAJOR)
ASMSTRIPFLAGS= -x
YASMFLAGS=-f macho64 -m amd64 -DPIC -DPREFIX
=======
DEPWINDRES=gcc -m64 -fPIC
...
EXTRALIBS=-framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreFoundation -framework VideoDecodeAcceleration -framework QuartzCore -L/usr/local/lib -lSDLmain -lSDL -Wl,-framework,Cocoa -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lpsapi -lole32 -lstrmiids -luuid -liconv -lm -lz -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
...
libavutil_VERSION=52.77.100
libavutil_VERSION_MAJOR=52
libavutil_VERSION_MINOR=77
