...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=./build/js/x86 --target-os=none arch=x86 --enable-cross-compile --cc=emcc --ar=emar --extra-cflags=-llibc --disable-runtime-cpudetect --disable-doc --disable-asm --disable-fast-unaligned --disable-pthreads --disable-w32threads --disable-os2threads --disable-debug --disable-stripping --disable-all --disable-asm --enable-shared --enable-static --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-muxers --disable-demuxers --disable-parsers --disable-filters --disable-hwaccels --enable-decoder=rawvideo --enable-encoder=rawvideo --enable-decoder=h263 --enable-encoder=h263p --enable-encoder=mjpeg --enable-decoder=mjpeg --disable-network --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-bzlib --disable-iconv --disable-xlib --disable-zlib
prefix=./build/js/x86
...
CC_IDENT=emcc (Emscripten gcc/clang-like replacement) 1.38.12 ((unknown revision))
ARCH=c
CC=emcc
CXX=g++
AS=emcc
...
CFLAGS=  -llibc -std=c99 -fomit-frame-pointer -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -llibc -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
WINDRES=windres
DEPWINDRES=emcc
LDFLAGS=  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments
...
CFLAGS-ffplay=-D_GNU_SOURCE=1 -D_REENTRANT
ZLIB=-lz
